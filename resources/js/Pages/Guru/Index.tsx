...
export default function Guru({ auth }: PageProps) {
const { students } = usePage().props as { students: any[] };
...
<div className="py-12">
 ...
 <div className="@container/main flex flex-1 flex-col gap-2 py-4">
                                <div className="flex justify-between px-6">
                                    <div className="flex space-x-2">
                                        <Button id="download-report-btn" asChild>
                                            <a href={route('guru.report.pdf')} target="_blank">
                                                Unduh Laporan
                                            </a>
                                        </Button>
                                        <Button id="download-unfinished-report-btn" asChild>
                                            <a href={route('guru.report.unfinished')} target="_blank">
                                                Unduh Laporan Belum Input
                                            </a>
                                        </Button>
                                    </div>
  ...
  <DataTable data={students} columns={getColumns} />
  </div>
 </div>
  </div>
 </div>
