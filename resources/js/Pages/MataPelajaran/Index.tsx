...
export default function MataPelajaran({ auth, subjects }: PageProps & { subjects: any[] }) {
    ...
    const handleDeleteType = async () => {
        try {
            ...
            router.delete(`/mata-pelajaran/${idDelete}`, {
                onSuccess: () => {
                    router.reload();
                },
            });
                        ...
                        <div className="flex flex-1 flex-col">
                            <div className="@container/main flex flex-1 flex-col gap-2 py-4">
                                ...
                                <div className="flex flex-col">
                                    <DataTable data={subjects} columns={getColumns} />
                                </div>
                            </div>
                        </div>
                    </div>
