       ...
       <div className="@container/main flex flex-1 flex-col gap-2 py-4">
                                <div className="flex justify-between px-6">
                                    <div className="flex space-x-2">
                                        <Button id="cetak-5-semester" asChild>
                                            <a href={route('nilai.report.last_five')} target="_blank">
                                                Cetak 5 Semester
                                            </a>
                                        </Button>
                                        <Button id="cetak-semua-semester" asChild>
                                            <a href={route('nilai.report.all')} target="_blank">
                                                Cetak Semua Semester
                                            </a>
                                        </Button>
                                    </div>
